      ...
      body: ListView(
        ...
        children: [
          ...
          if (c != null) ...[
            ...
            _row('engine_auto', '${c.engineAuto}'),
            _row('tag_filter', '${c.tagFilter}'),
            _row('local_budgets', '${c.localBudgets}'),
            _row('annual_report', '${c.annualReport}'),
            _row('merchant_aliases', '${c.merchantAliases}'),
            _row('ocr_raw', '${c.ocrRaw}'),
            _row('csv_import', '${c.csvImport}'),
            _row('json_import', '${c.jsonImport}'),
            _row('backup_merge', '${c.backupMerge}'),
            _row('image_preprocess', '${c.imagePreprocess}'),
